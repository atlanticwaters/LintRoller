...
export function ResultItem({ violation, showNodeInfo, showRuleInfo, onSelect, onFix, onFixWithToken, onUnbind, onDetach, onApplyStyle, onIgnore, isFixed, isIgnored, isUnfixable, isFixing }: ResultItemProps) {
